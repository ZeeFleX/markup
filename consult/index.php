...
<body class="default-template page-profile">
    ...
    <div class="wrapper">
        ...
        <ol>
            ...
            <li><a href="page_profile_settings_worktime.php">Страница настроек. Рабочее время (консультант)</a></li>
            ...
            <li><a href="modal_signup_to_consultation_light.php">Окно записи на консультацию. (простое)</a></li>
