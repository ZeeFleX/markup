...
(function (factory) {
	...
	var methods = {
		init: function(options)
		{
			return this.each(function()
			{
				...
				for (var key in $.fn.timepickerLight.defaults) {
					if (self.data(key))  {
						attributeOptions[key] = self.data(key);
					}
				}

				var settings = $.extend({}, $.fn.timepickerLight.defaults, attributeOptions, options);
	...
	*/
	...
	// Plugin entry
	$.fn.timepickerLight = function(method)
	{
