...
<body>
    <section class="page">
        ...
        <div class="wrapper">
            ...
            <p class="endnote">
                Для тех, кто хочет быть здоровым, любимым и богатым уже в этой жизни
            </p>
    ...
    <noscript>
        <div style="width:0px;height:0px;overflow:hidden;"><img src="//stat.clickfrog.ru/no_script.php?img" style="width:0px; height:0px;" alt="" />
        </div>
    </noscript>
    <script type="text/javascript">
        var clickfrogru_uidh = '03083942f06aac7b92739397121382cc';
    </script>
