...
<body>
    <section class="page">
        <div class="wrapper">
            <span class="start">Открыт секрет массовых неудач в личной жизни, карьере и бизнесе</span>
            <h1 class="white">
                ЕСТЬ ВЕЩИ, ИГНОРИРОВАТЬ КОТОРЫЕ<br />
                <span>ОПАСНО</span> ДЛЯ ЗДОРОВЬЯ
            </h1> 
            <div class="player">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/p4xqIucDAcQ?autoplay=1" frameborder="0" allowfullscreen></iframe>
            </div>
