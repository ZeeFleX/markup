...
! function(d) {
    ...
    return {
        errorLoading: function() {
            return "Результат не может быть получен."
        },
        inputTooLong: function(a) {
            var b = a.input.length - a.maximum,
                c = "Пожалуйста, удалите " + b + " символов";
            return 1 != b && (c += "s"), c
        },
        inputTooShort: function(a) {
            var b = a.minimum - a.input.length,
                c = "Введите " + b + " или больше символов";
            return c
        },
        ...
        maximumSelected: function(a) {
            var b = "Вы можете выбрать максимум " + a.maximum + " значений";
